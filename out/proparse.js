...
exports.optandargs = exports.parse = void 0;
...
function parse(_input) {
    ...
    if (ctx.inquo)
        ctx.word = ctx.qchar + ctx.word;
    if (ctx.eword.length > 0)
        ctx.word += ctx.eword;
...
exports.parse = parse;
function optandargs(args, expect = {}, prefix = "-") {
